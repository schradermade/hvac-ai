 ...
 * My Profile Screen
 *
 * Self-view variation of TechnicianDetailScreen
 * Shows current user's own technician profile
 */
...
export function MyProfileScreen() {
  const { data: technician, isLoading, error } = useCurrentTechnician();
          ...
          {technician.certifications.length > 0 ? (
            ...
            <Card style={styles.emptyCard}>
              ...
              <Text style={styles.emptyHint}>
                Contact your administrator to update certifications
              </Text>
            </Card>
          )}
        </View>
